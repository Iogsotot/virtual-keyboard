 ...
 */
 ...
 export default function create(el, classNames, progeny, parent, ...dataAttr) {       // ... - rest operator
    let element = null;
    ...
    /* проверяем ...dataAttr . dataAttr - двумерный массив: [['attrName', 'attrValue'], ['attrName', 'attrValue'], ['attrName', 'attrValue']]*/
