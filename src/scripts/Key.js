...
export default class Key {
  constructor({ small, shift, code, sound }) {
    ...
    this.shift = shift;
    this.sound = sound;
    this.isFnKey = Boolean(code.match(/ControlLeft|ArrowRight|ArrowLeft|ArrowUp|ArrowDown|ControlRight|AltLeft|AltRight|ShiftLeft|ShiftRight|Tab|Del|Enter|Caps|Esc|Win|Mic|Lang|Clear|Backspace|SoundKeySwitch|BackgroundSound|CloseKeyboard/));
